...
- العمل التالي الموصى به: إعادة كتابة قصة وحوارات `Shadow Grid` بالعربية أولًا
  وبناء نظام حوار داخل اللعب في الشريط السفلي بدل الشاشة الكاملة، ثم إعداد
  الإنجليزية كتكييف طبيعي غير حرفي قبل إضافة مراحل أو أعداء جدد.
...
- الإجراء التالي المقترح: إعادة كتابة Story Bible وBeat Sheet بالعربية أولًا،
  ثم تنفيذ صندوق الحوار السفلي ودخول الزعماء، وبعد اعتماد النبرة تُكيّف الإنجليزية
  وتُختبر الحملة على Shield وXiaomi Stick.
