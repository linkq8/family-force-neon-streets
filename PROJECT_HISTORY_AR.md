...
- العمل التالي الموصى به: جلسة لعب قتالية حقيقية طويلة 20–30 دقيقة على جهاز
  Android TV منخفض الذاكرة، تشمل الأسلحة والموت والإحياء والـContinue والزعيم.
...
- آخر قرار: تنفيذ بوابة Release Candidate للاستقرار أولًا، ثم updater داخلي آمن
  مع مثبت Android وfallback لصفحة GitHub؛ لم يُنفذا بعد.
...
- الإجراء التالي المقترح: اختبار لعب قتالي طويل حقيقي على Android TV منخفض
  الذاكرة، ثم تسجيل النتائج هنا قبل إصدار النسخة التالية.
