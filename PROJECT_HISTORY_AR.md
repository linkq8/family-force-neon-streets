...
- أحدث201: اكتمل الإصلاح البرمجي واختبار APK؛ النشر جارٍ. المشغل يستأنف
...
- الحالة: إصلاح برمجي مختبر، قيد نشر APK؛ الصقل الفني لم يكتمل.
...
- Release: APK جاهزة للنشر بالوسم unity-v0.5.2-essa-motion؛ النسخة
  ...
  تحت art-pipeline/builds/Essa/motion-201. يضاف commit ورابط الرفع عند اكتماله.
...
- التالي: نشر APK ثم اختبار المستخدم على جهازه؛ تحريك مفاتيح جسم متمايزة
...
- أحدث201: الإصلاح البرمجي مختبر على Unity وAndroid؛ استئناف المشي بعد
  ...
  لا مرشح المفاصل. OCR أكد عرض12 إطارًا في فيديو المحاكي. النشر جارٍ؛
