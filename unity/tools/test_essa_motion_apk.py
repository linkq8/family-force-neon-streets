...
APK=ROOT/'unity/Builds/Android/FamilyForceUnity-EssaMotion-0.5.2.apk'
...
for required in ["package: name='com.familyforce.neonstreets.unityprototype'",
                 "versionCode='3'","versionName='0.5.2-essa-motion-fix'",
...
data={'status':'PASS','package':'com.familyforce.neonstreets.unityprototype',
      'version_name':'0.5.2-essa-motion-fix','version_code':3,'abis':['arm64-v8a','armeabi-v7a'],
...
(ROOT/'unity/Builds/EssaMotion201/apk-validation.json').write_text(json.dumps(data,indent=2)+'\n')
