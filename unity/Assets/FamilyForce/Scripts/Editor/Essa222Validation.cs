...
namespace FamilyForce.Unity.Editor
{
    ...
    {
        public static void Run(bool smooth = false)
        {
            ...
            for(int k=0;k<actions.Length;k++)
            {
                ...
                {
                    Check(frame.name.StartsWith(smooth && k==1 ? "Essa225_" : "Essa222_"),"Wrong resource");
            ...
            Check(seen.Count==14,"Faster punch skipped drawings");Tick(.0034f);
            ...
            if(smooth)
            {
                ...
                File.WriteAllText("Builds/Motion225/atlas-validation.json","{\"status\":\"PASS\",\"frames\":120,\"cell\":384,\"bilinear\":true,\"fixedPivotAndScale\":true,\"combatTimingUnchanged\":true}");
                return;
            }
